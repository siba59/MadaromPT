const SPECIALISTI = {
  ...
  filosofo:           { id: "filosofo",           nome: "Filosofo",               emoji: "🌍", ruolo: "Filosofia applicata alla PT" },
  pedagogista:        { id: "pedagogista",         nome: "Pedagogista",            emoji: "📚", ruolo: "Formare formatori PT" },
  tuttologo:          { id: "tuttologo",           nome: "Tuttologo Consapevole",  emoji: "🧭", ruolo: "Ponti tra discipline PT" },
  neuroscienziato:    { id: "neuroscienziato",     nome: "Neuroscienziato",        emoji: "🧠", ruolo: "Neuroscienze e PT" },
  tattico:            { id: "tattico",             nome: "Esperto Tattico",        emoji: "♟️", ruolo: "Analisi tattica PT" },
  tecnico:            { id: "tecnico",             nome: "Esperto Tecnico",        emoji: "🎯", ruolo: "Tecnica nel modello PT" },
  fisiologo:          { id: "fisiologo",           nome: "Fisiologo",              emoji: "🏃", ruolo: "Fisiologia morfociclo PT" },
  psicologo:          { id: "psicologo",           nome: "Psicologo dello sport",  emoji: "🧘", ruolo: "Psicologia nel morfociclo PT" },
  matematico:         { id: "matematico",          nome: "Matematico complessita", emoji: "📐", ruolo: "Sistemi complessi PT" },
  economista:         { id: "economista",          nome: "Economista calcio africano", emoji: "💼", ruolo: "Academy PT Africa" },
  traduttore:         { id: "traduttore",          nome: "Traduttore-Localizzatore",   emoji: "🌐", ruolo: "Multilingua PT" },
  web_editor:         { id: "web_editor",          nome: "Web Editor",             emoji: "✍️", ruolo: "Comunicazione Madarom" },
  direttore:          { id: "direttore",           nome: "Visione d insieme",      emoji: "🔮", ruolo: "Sintesi PT" }
};
